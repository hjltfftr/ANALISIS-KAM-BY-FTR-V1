    ...
    if not GEMINI_KEY and not GROQ_KEY:
        ...
        with st.spinner("⏳ [3/4] AI sedang menyusun ringkasan (Mencoba Gemini, bersiap Groq)..."):
            ...
            for name, text in documents.items():
                prompt_summary = f"""Anda adalah gabungan seorang Auditor Senior dan Analis Ekuitas Pasar Modal. Ekstrak Key Audit Matters (KAM) berikut dengan singkat dan tajam dengan total ringkasan maksimal 6000 kata:
